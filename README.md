...
| find-skills | Discover and install agent skills from the ecosystem | N/A |
...
| [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) | Search and analyze X data through Xquik REST and MCP | N/A |
